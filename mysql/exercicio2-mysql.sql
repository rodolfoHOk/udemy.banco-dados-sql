/* exercicio */
/* criar o banco com os scrypts abaixo */
...
-- temos 975 funcionarios

SELECT departamento, COUNT(*) FROM funcionarios
GROUP By departamento
ORDER BY 2;

-- filmes tem 21 funcionarios e roupas tem 53 funcionarios usaremos OR então para obter melhor performance quem tem mais primeiro

SELECT idFuncionario, nome, sexo, departamento, cargo FROM funcionarios
WHERE departamento = 'roupas' OR departamento = 'filmes';

/* ex 02
	O gestor de marketing pediu a lista das funcionarias *(Feminino)* que trabalhem no departamento 
...
-- temos funcionario 484 masculinos e temos funcionarios 491 femininios usaremos AND então para obter performande quem tem menos ocorrencias primeiro
-- filmes tem 21 funcionarios e lar tem 52 no total 73 funcionarios usaremos OR então para obter performance quem tem mais primeiro

SELECT nome, sexo, email, departamento FROM funcionarios
WHERE (departamento = 'roupas' OR departamento = 'filmes') AND sexo = 'Feminino';
-- igual (mesmo resultado) abaixo
SELECT nome, sexo, email, departamento FROM funcionarios
WHERE (departamento = 'roupas' AND sexo = 'Feminino') OR (departamento = 'filmes' AND sexo = 'Feminino');
...
GROUP By departamento
ORDER BY 2;
-- temos 47 funcionarios que trabalham no setor Jardim

SELECT sexo, COUNT(*) FROM funcionarios
GROUP BY Sexo
ORDER BY 2;
-- temos funcionario 484 masculinos e temos funcionarios 491 femininios

-- usaremos OR então para obter performance quem tem mais primeiro
SELECT idFuncionario, nome, sexo, departamento, cargo FROM funcionarios
